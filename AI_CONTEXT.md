...
Микросервис интегрируется с остальными через общую docker сеть social-network-net.
...
**Основные пакеты:(пакеты не актуальны, нужно переделать схему в соответствие с текущей структурой)**
